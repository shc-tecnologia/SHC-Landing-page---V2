    ...
    <section className="relative pt-48 pb-20 px-6">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 text-center lg:text-left z-10">
          <div className="inline-flex items-center space-x-3 px-4 py-2 mb-8 rounded-full bg-blue-500/5 border border-blue-500/10 text-blue-400 text-[10px] font-black uppercase tracking-[0.3em]">
            <span className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></span>
            <span>SHC BOX - Software de gestão</span>
          </div>
          
          <h1 className="font-modern text-6xl md:text-8xl font-black text-white mb-8 leading-[0.9] tracking-tighter">
            SUA EMPRESA <br/> 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300 italic">DENTRO DA BOX.</span>
          </h1>
          
          <p className="max-w-xl mx-auto lg:mx-0 text-slate-400 text-lg md:text-xl font-light leading-relaxed mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
            <button 
              onClick={onSignUp}
              className="w-full sm:w-auto px-12 py-6 bg-blue-600 text-white rounded-full font-black text-sm uppercase tracking-widest hover:bg-blue-500 transition-all shadow-2xl shadow-blue-500/30 active:scale-95 border-t border-white/20"
            >
              ADQUIRIR SHC BOX
            </button>
            <button 
              onClick={scrollToProduct}
              className="w-full sm:w-auto px-12 py-6 glass-deep text-white rounded-full font-black text-sm uppercase tracking-widest hover:bg-white/5 transition-all border border-blue-500/20"
            >
              VER POR DENTRO
            </button>
          </div>
        ...
        <div className="flex-1 relative w-full group">
          <div className="relative z-10">
             <div className="glass-deep p-4 rounded-[3.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.6)] border border-white/10 relative overflow-hidden">
                ...
                <div className="bg-slate-900 rounded-[3rem] overflow-hidden border border-white/5 relative">
                  <img 
